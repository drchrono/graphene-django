...
class DjangoFilterConnectionField(DjangoConnectionField):
    ...
    @classmethod
    def resolve_queryset(cls, connection, iterable, inof, args, filtering_args, filterset_class):
        filter_kwargs = {k: v for k, v in args.items() if k in filtering_args}
        return filterset_class(data=filter_kwargs, queryset=iterable, request=info.context)
